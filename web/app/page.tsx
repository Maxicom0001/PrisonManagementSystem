...
export default function PrisonHomepage() {
    ...
    return (
        <motion.div className="w-full max-w-7xl p-6" initial="hidden" animate="visible" variants={containerVariants}>
            ...
            <motion.div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12" variants={itemVariants}>
                <div className="space-y-4">
                    ...
                    <motion.p className="text-muted-foreground" variants={itemVariants}>
                        Our prison is a modern correctional facility designed in accordance with the highest standards of security and rehabilitation. We have
                        200 cells, a sports complex, vocational workshops, and a medical center. Our goal is not only to ensure public safety but also effective
                        rehabilitation of inmates.
                    </motion.p>
                    <motion.p className="text-muted-foreground" variants={itemVariants}>
                        The facility was opened in 2010 and has since undergone several upgrades to meet evolving safety requirements and inmate care standards.
                    </motion.p>
                </div>
                <motion.div
