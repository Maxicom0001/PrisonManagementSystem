                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                <div className="flex flex-col p-3 bg-red-50 dark:bg-red-950/20 rounded-lg">
                                    ...
                                    <div className="mt-2 flex items-center text-xs text-muted-foreground">
                                        ...
                                        <span>Facility at {Math.round((prisonData.prisoners.total / prisonData.prison.totalCells) * 100)}% capacity</span>
                                    </div>
                                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="flex flex-col">
                                    ...
                                    <div className="flex items-center gap-1 mt-1">
                                        ...
                                        <span className="text-xs text-muted-foreground">{new Date(prisonData.prisoners.newest.date).toLocaleDateString()}</span>
                                    </div>
                                    <Button variant="outline" size="sm" className="mt-2">
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    >
                                        ...
                                        <Badge
                                            variant={item.status === "Completed" ? "outline" : item.status === "In progress" ? "secondary" : "default"}
                                            className={
