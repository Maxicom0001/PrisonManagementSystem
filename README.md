...
- [@Jakub Batko](https://github.com/Nasakrator) - Frontend oraz intergracja API, CRUDy i baza danych.
- [@Mateusz Lis](https://github.com/Maxicom0001) - Klepanie CRUDów, Opieka nad ogniem współpracy drużynowej.
- [@Bartłomiej Szymczyk](https://github.com/GunterJP) - Wielojęzyczna baza danych.
- [@Dawid Szymczyk](https://github.com/Crime420)- Readme.md oraz tworzenie kompleksowej dokumentacji i zadbanie o drużyne.
- [@Aleksander Węglarz](https://github.com/kmcls)- zarządzanie i administrowanie pojazdami służbowymi
- [@Dominik Zawisza](https://github.com/Dominanima)- Zadbanie o odpowiednie zarządzanie budżetem oraz zapewnienie dofinansowań unijnych.
- [@Jan Żaba](https://github.com/ZabkaJ) - TBA
- [@Maria Sowula](https://github.com/M4r14Sowul4) - Update pom.xml(deprecated).
## Documentation
### 👤 Osadzeni (`/CONVICTS`)
